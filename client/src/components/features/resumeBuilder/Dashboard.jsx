...
const Dashboard = () => {
  ...
  return (
    <div>
      ...
      from-cyan-500 to-purple-500 bg-clip-text text-transparent"
        >
        ...
        <div className="flex gap-4">
          <button
            ...
            className="w-full bg-[radial-gradient(circle_at_top_left,#160027,#00232d)] backdrop-blur-md sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-300
        border border-dashed border-indigo-400/40 group
        hover:border-indigo-400/80 hover:bg-[radial-gradient(circle_at_top_left,#160027,#00232d)]/15 transition-all
        ...
        hover:border-purple-400/80 hover:bg-[radial-gradient(circle_at_top_left,#160027,#00232d)]/15 transition-all
        duration-300 cursor-pointer"
          >
            <UploadCloudIcon
              className="size-11 transition-all duration-300 p-2.5
            ...
            showCreateResume && (
              <form
                ...
                <motion.div
                  ...
                  className="bg-[radial-gradient(circle_at_top_left,#160027,#00232d)] border border-purple-500/30 rounded-2xl p-8 w-full max-w-md relative shadow-2xl"
        ...
        <AnimatePresence>
          {
            showUploadResume && (
              <form
                ...
                <motion.div
                  onClick={(e) => e.stopPropagation()}
                  className="bg-[radial-gradient(circle_at_top_left,#160027,#00232d)] border border-purple-500/30 rounded-2xl p-8 w-full max-w-md relative shadow-2xl max-h-[90vh] overflow-y-auto"
                  initial={{ opacity: 0, scale: 0.95, y: 20 }}
                  animate={{ opacity: 1, scale: 1, y: 0 }}
                  exit={{ opacity: 0, scale: 0.95, y: 20 }}
                  transition={{ type: 'spring', stiffness: 300, damping: 25 }}
