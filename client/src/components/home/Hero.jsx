...
const Hero = () => {
  ...
  return (
    <div className="w-full">
      ...
      px-4 sm:px-6 lg:px-12 pt-20 relative">
        ...
        >
          <button
            ...
            className="bg-linear-to-r from-purple-500 to-cyan-400
              active:scale-95 transition-all text-white rounded-full px-7 h-11 cursor-pointer text-xs md:text-base">
            Get started
          </button>
          <button className="flex items-center gap-2 border border-purple-400/60 text-white hover:bg-purple-500/20 transition-all active:scale-95 rounded-full px-6 h-11 cursor-pointer text-xs md:text-base">
